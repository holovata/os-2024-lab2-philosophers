...
namespace philosophers_try2
{
    public class ConfigValue
    {
        ...
        public int PhilosophersCount => GetIntValue("Philosopher Count", 5);
        public int ForksCount => GetIntValue("Fork Count", PhilosophersCount);
        public int MaxPhilsophersEatingSimultaneously => GetIntValue("Max philosophers to eat simultaneously", 2);
        public int DinnerDuration => GetIntValue("Duration Allow Philosophers To Eat [seconds]", 20_000) * 1_000;
